 ...
 */
const getAllByBoard = async (): Promise<Array<object>> => DB.getAllTasksByBoard();
/**
 ...
 */
const create = async (task: Task): Promise<object> => DB.createTask(task);
/**
...
const delById = async (id: string): Promise<object | boolean> => {
   ...
   */
  const update = async (id: string, modTask: Task): Promise<object | boolean> => {
